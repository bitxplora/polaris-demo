...
export default class Password extends Component<PasswordSignature> {
  ...
  <template>
    ...
    <div class="relative" max-w-fit>
      ...
      <div class="absolute size-2 top-1 left-56" role="button" tabindex="0" aria-label="ToggleButton"  {{ on 'click' this.toggleEye }}>
        {{#if this.eyeToggled }}
          <svg xmlns="http://www.w3.org/2000/svg" role="presentation"  width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye-off">
        ...
        {{ else }}
          <svg xmlns="http://www.w3.org/2000/svg" role="presentation" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye">
