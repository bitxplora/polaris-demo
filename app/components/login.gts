...
const Login: TOC<LoginSignature> =  <template>
    <div class='w-screen h-screen'>
      <div class='bg-purple-600 w-full h-full grid justify-center place-items-center'>
        <div class='bg-purple-200 w-80 h-fit p-6 gap-y-16 rounded-md grid justify-center justify-items-center'>
