...
const Login: TOC<LoginSignature> =  <template>
    <div class='w-screen h-screen'>
      <div class='bg-purple-950 w-full h-full grid justify-center place-items-center overflow-auto'>
        <div class='bg-purple-200 w-80 h-fit p-6 m-8 gap-y-16 rounded-md grid justify-center justify-items-center sm:w-96'>
          ...
          <form id='signform' class='grid justify-center gap-y-4'>
            <div class='grid justify-center'>
              ...
              <input class="w-64 h-8 rounded pl-2 text-sm border border-purple-950 sm:w-80" type="text" id="username" name="username" placeholder="john@example.com" required>
            </div>
            <div class='grid justify-center'>
            ...
            <div class="grid content-between gap-y-9">
              <ul class="flex justify-between text-xs text-orange-950 font-bold font-mono tracking-tight">
                <li>Sign up</li>
